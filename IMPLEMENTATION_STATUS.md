...
- A 34-screen, read-only Firefox training capture catalog covering project and lab lifecycle, visual topology design, verified backup/restore, image onboarding/deletion, deployment/device lifecycle and guarded removal, safe redeploy preview, runtime logs, link controls, ping/traceroute diagnostics, packet capture, console, configuration history/compare/restore, templates, jobs, security, and API discovery.
