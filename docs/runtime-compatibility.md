...
| Uploaded-image registry mirroring | Unverified | Current verified publication imports into the selected node's containerd store; registry mirroring and multi-node pull validation are not yet claimed. |
